...
#
#   Local dev VM:  sudo -u postgres bash supabase/test/run_tests.sh
#   CI / custom:   PGHOST=localhost PGUSER=postgres PGPASSWORD=postgres bash supabase/test/run_tests.sh
#
...
echo "==> Granting authenticated/service_role privileges (Supabase does this automatically)"
